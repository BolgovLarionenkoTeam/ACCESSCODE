  // Main executable file of the ACCCESCODE project
  // TODO: 3) Автоматическое включение GSM при включении arduino; 6) Задержки после неверных СМС и RFID (Что делать с длинными смс? (for вместо while)); 
...
//----------------------------------------NOTIFICATIONS------------------------------------------------
  ...
  #define PHONE_NUMBER "+79632925313"
...
//----------------------------------------CONSTANTS----------------------------------------------------
  ...
  String TRUE_RFID_ID_1 = "772"; //ID of RFID carf
  String TRUE_RFID_ID_2 = "4294946563";
  String TRUE_PASSWORD_UNLOCK = "000000"; //sms login password
  String TRUE_PASSWORD_DESTRUCT = "159753"; //self-destruction password
  ...
  String SELF_DESTRUCTION_SMS = "79632925313639582"; // +79632925313, 639582
  String UNLOCK_SMS = "79632925313758963"; // +79632925313, 758963
  String LOCK_SMS = "79632925313539754"; // +79632925313, 539754
